...
```SQL
SELECT company_name,count(o) orders_count
...
```SQL
 SELECT c.contact_name,count(o) orders_count
 from customers c LEFT JOIN orders o
 ON c.customer_id = o.customer_id
...
```SQL
SELECT c.city,count(o) orders_count
 from customers c LEFT JOIN orders o
 ON c.customer_id = o.customer_id
 GROUP BY c.city
 ORDER BY c.city;
...
| person_id  |  name      |    yard    |city dweller|            |            |            |            |            |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|
|    1       |  Jane      |    no      |    yes     |            |            |            |            |            |
|    2       |  BOB       |   no       |    no      |            |            |            |            |            |
|   3        |  Sam       |  yes       |    no      |            |            |            |            |            |
...
|    pet_id  |  pet_name  | type id    | person_id  |            |            |            |            |            |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|
|     1      |  Ellie     |   1        |   1        |            |            |            |            |            |
|    2       |   Joe      |   3        |   2        |            |            |            |            |            |
|    3       |  Ginger    |   1        |   3        |            |            |            |            |            |
